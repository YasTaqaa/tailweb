      ...
      <div className="w-2/3 mx-auto p-40">
        <div className="bg-gradient-to-r from-purple-300 to-blue-200 rounded-lg shadow-md p-9">
          ...
          <div class="w-full text-center">
              <div class="flex justify-center pt-8 pb-0 lg:pt-4">
                <div class="flex space-x-2">
                  <a
                    class="p-1 -m-1 text-blue-400 hover:text-blue-900 focus:outline-none focus-visible:ring-2 ring-primary"
                    href="https://github.com/YasTaqaa"
                  ...
                  <a
                    class="p-1 -m-1 text-blue-400 hover:text-blue-900 focus:outline-none focus-visible:ring-2 ring-primary"
                    href="https://www.instagram.com/yasstq_/"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                    <svg
          ...
          <div className="mt-5 text-center">
            <h2 className="text-lg font-semibold">Referensi </h2>
              <div className="mt-1 flex items-center justify-center">
                <a
                  href="https://honkaiimpact3.hoyoverse.com/global/en-us/home"
                  className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500"
                >
                  Official Site Honkai Impact 3rd
               </a>
              </div>
          </div>
        </div>
